/**
 * GET/POST /api/config — read and save the Setup configuration (FR-25): owner
 * name, scraper strategy, and saved-search keywords × locations (FR-2), among
 * the rest of the settings form. One row (id = 1).
 */
